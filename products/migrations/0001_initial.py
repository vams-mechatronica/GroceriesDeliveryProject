    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "position",
                    products.models.ModifiedArrayField(
                ...
                (
                    "banner_name",
                    models.CharField(
                        blank=True, max_length=50, null=True, verbose_name="bannername"
                    ),
                ),
                (
                    "banner_images",
                    models.ImageField(
                        upload_to="banners/20230207", verbose_name="bannerimages"
                    ),
                ),
                (
                    "banner_status",
            ...
            fields=[
                ...
                (
                    ...
                    models.ImageField(
                        ...
                        default=None,
                        null=True,
                        upload_to="product/20230207",
                        verbose_name="Product Main Image",
                    ),
                ),
                (
                    "modified_at",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "review",
                    models.CharField(
                        max_length=1024, null=True, verbose_name="Product Review"
                    ),
                ),
                (
                    "ratings",
                ...
                (
                    ...
                    models.ImageField(
                        null=True,
                        upload_to="review/20230207",
                        verbose_name="ImagesForReview",
                    ),
                ),
                (
                    "review_date",
                    models.DateTimeField(auto_now=True, verbose_name="review_date"),
                ),
                (
                    "author",
                    models.ForeignKey(
                ...
                (
                    ...
                    models.ForeignKey(
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="prodReviews",
                        to="products.products",
                        verbose_name="ProdReviews",
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "images",
                    models.ImageField(
                        upload_to="product/20230207", verbose_name="Product_Image"
                    ),
                ),
                (
                    "products",
